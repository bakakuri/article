...
function renderHome() {
  ...
  document.getElementById('page-home').innerHTML = `
    <section class="hero">
      ...
      <img class="hero-image" src="assets/hero-book.svg" alt="A1 წიგნი">
    ...
    <div class="feature-grid">
      <div class="feature-card flashcards" id="home-btn-fc">
        ...
        <img class="feature-art" src="assets/flashcards.svg" alt="ფლეშქარდები">
        <button class="feature-button">→</button>
      </div>
      <div class="feature-card grammar" id="home-btn-gr">
        <h2>გრამატიკა</h2>
        <p>ისწავლე ძირითადი წესები</p>
        <img class="feature-art" src="assets/grammar.svg" alt="გრამატიკა">
        <button class="feature-button">→</button>
      </div>
    </div>
