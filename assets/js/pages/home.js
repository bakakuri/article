...
function renderHome() {
  ...
  document.getElementById('page-home').innerHTML = `
    ...
    <div class="home-quiz-banner" id="home-btn-quiz">
      <div class="hqb-left">
        <div class="hqb-icon">🧩</div>
        <div>
          <div class="hqb-title">Quiz Mode</div>
          <div class="hqb-sub">4 ვარიანტი · სწრაფი შემოწმება</div>
        </div>
      </div>
      <div class="hqb-arr">→</div>
    </div>
  ...
  document.getElementById('home-btn-quiz').addEventListener('click', () => startQuizMode(10));
